...
function _bbapi_civix_mixin_polyfill() {
 ...
 */
function _bbapi_civix_civicrm_enable(): void {
  _bbapi_civix_civicrm_config();
  _bbapi_civix_mixin_polyfill();
}
  ...
  if (empty($path)) {
    ...
    foreach ($menu as $key => &$entry) {
      if ($entry['attributes']['name'] == $first) {
        ...
        $found = _bbapi_civix_insert_navigation_menu($entry['child'], implode('/', $path), $item);
      }
    }
    return $found;
  }
